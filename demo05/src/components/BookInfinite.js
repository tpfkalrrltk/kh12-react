...
import throttle from "lodash/throttle"//특정함수의 발생 주기를 설정(강제 성능 하향)
//사용법 - throttle(원래쓰려고 했던 함수, 주기)
import debounce from "lodash/debounce"// 특정 이벤트의 마지막만 실행되도록 설정
//사용법 - debounce(원래쓰려고 했던 함수, 주기)
...
const BookInfinite = () => {
    ...
    /////////////////////////////////////////////////////////////////////////
    //스크롤 이벤트처리(scroll event handing)
    // - 화면이 실행되면 window에 scroll이벤트 설정
    // - 화면이 해제되기 직전에 이벤트 해제
    /////////////////////////////////////////////////////////////////////////
    useEffect(() => {
