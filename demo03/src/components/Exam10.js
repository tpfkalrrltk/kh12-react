                    ...
                    product.edit ? (
                        <tr className="table-light ">
                            <div className="row mb-1 text-center">
                                ...
                                <td className="col-3"> <input type="text" value={product.itemName} size={5} /></td>
                                <td className="col-2">
                                    <input type="text" value={product.itemPrice}  size={5}/>
                                </td>
                                <td className="col-2"><input type="text" value={product.itemType} size={5} /></td>
                            </div>
                        </tr>
                    ) : (
                        <tr className="table-light ">
